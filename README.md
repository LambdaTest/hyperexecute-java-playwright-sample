# Hyperexecute-Java-Playwright-Sample — TestMu AI (Formerly LambdaTest)
...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=JUnit&frameworkType=PlayWright)
---
...
# How to run Playwright automation tests in Java on HyperExecute (using Junit framework)
...
## Auto-Split Execution with Java
...
#### Execute Java tests using Autosplit mechanism on Windows platform
