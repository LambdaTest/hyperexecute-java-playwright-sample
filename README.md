# Run Java Playwright Tests with HyperExecute on TestMu AI (Formerly LambdaTest)

<p align="center">
  <a href="https://www.testmuai.com/"><img src="https://img.shields.io/badge/MADE%20BY%20TestMu%20AI-000000.svg?style=for-the-badge&labelColor=000" alt="Made by TestMu AI"></a>
  <a href="https://central.sonatype.com/artifact/org.seleniumhq.selenium/selenium-java"><img src="https://img.shields.io/maven-central/v/com.microsoft.playwright/playwright.svg?style=for-the-badge&labelColor=000000" alt="Playwright Java version"></a>
...
With TestMu AI (Formerly LambdaTest), you can run Java Playwright tests using HyperExecute. This sample shows how to configure Java + Playwright + HyperExecute to run on the TestMu AI cloud.

- [Sign up on TestMu AI](https://www.testmuai.com/register/) (Formerly LambdaTest).
- Follow the [Run Playwright tests with JUnit on HyperExecute](https://www.testmuai.com/support/docs/playwright-junit-on-hyperexecute/) for the full setup walkthrough.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-java-playwright-sample && cd hyperexecute-java-playwright-sample
